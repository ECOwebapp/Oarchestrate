    ...
    <div v-else class="flex flex-col h-full min-h-0">
      ...
      >
        ...
        <button
          ...
          class="flex items-center gap-2 font-bold h-11 px-4 rounded-2xl transition-all text-sm hover:cursor-pointer outline outline-2 outline-green-950 bg-white text-green-950 hover:bg-green-50 flex-shrink-0 disabled:opacity-40 disabled:cursor-not-allowed"
        >
          <div
        ...
        <Transition name="fade-slide">
          <button
            ...
            class="flex items-center gap-2 h-11 px-5 rounded-2xl font-bold text-sm transition-all hover:cursor-pointer bg-red-700 text-white hover:bg-red-800 active:scale-95 flex-shrink-0"
          >
