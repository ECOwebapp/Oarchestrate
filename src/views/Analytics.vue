...
import AccomplishmentReport from "@/components/Analytics/AccomplishmentReport.vue";
...
<template>
        ...
        >
            ...
            >
                <div
                    ...
                    class="flex min-h-65 flex-col rounded-xl bg-white p-4 shadow-sm md:h-full md:min-h-0 animate-pulse"
                >
    ...
    <div v-else class="overflow-auto">
        ...
        >
            ...
            <ReportGeneratorElement>
                <div class="mt-4 flex flex-col gap-2 lg:mt-auto lg:shrink-0">
                    <button
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div
                            class="flex w-full flex-col gap-2 sm:w-auto sm:gap-2.5"
                        >
                            <div
                                v-for="d in pieData"
                                :key="d.label"
