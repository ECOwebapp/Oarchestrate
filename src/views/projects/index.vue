...
const deleteTasks = async () => {
  ...
  try {
    ...
    deleteError.value = err.message || 'Failed to delete projects. Please try again.'
  } finally {
  ...
  <div class="flex flex-col h-full min-h-0">
    ...
    <div v-else class="flex flex-col h-full min-h-0">
      ...
      <div class="flex flex-wrap items-center gap-3 px-4 sm:px-6 lg:px-10 py-4 flex-shrink-0">
        ...
        <!-- Add Task -->
        <button v-if="!selectionMode && auth.isDirector" @click="addTask = true"
        ...
        <button v-if="canDelete" @click="toggleSelectMode"
          class="flex items-center gap-2 font-bold h-11 px-5 rounded-2xl transition-all text-sm flex-shrink-0 hover:cursor-pointer" :class="selectionMode
        ...
        <Transition name="fade-slide">
          <div v-if="selectionMode && selectedCount > 0"
            ...
            <span v-if="auth.isUnitHead && !auth.isDirector && deletableSelectedCount < selectedCount"
        ...
        <div v-if="showDeleteConfirm" class="fixed inset-0 z-[200] flex items-center justify-center bg-black/50 px-4"
          ...
          <div class="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm flex flex-col gap-4">
            ...
            <div class="text-center">
              ...
              <p v-if="auth.isUnitHead && !auth.isDirector && deletableSelectedCount < selectedCount"
            ...
            <!-- Error -->
            <p v-if="deleteError" class="text-red-600 text-xs text-center bg-red-50 rounded-lg px-3 py-2">
              {{ deleteError }}
            </p>
...
.fade-slide-enter-active {
  animation: fadeSlideIn 0.2s cubic-bezier(.16, 1, .3, 1) both
}
