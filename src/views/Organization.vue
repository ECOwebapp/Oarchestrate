        ...
        <div class="w-max min-w-full flex justify-center px-2 pt-3 pb-5">
          ...
          >
            ...
            >
              ...
              <div class="grid justify-items-center" :style="unitGridStyle">
                <div
                ...
                >
                  ...
                  <div class="flex flex-col items-center">
                    ...
                    />
                    <VLine v-if="orgData.pdu.juniorDrafts.length" />

                    <div
                      v-if="orgData.pdu.juniorDrafts.length"
                      class="relative min-h-[14px]"
                ...
                >
                  ...
                  />
                  <VLine v-if="orgData.piu.siteEngineers.length" />
