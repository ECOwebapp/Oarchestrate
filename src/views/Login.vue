...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (response?.status_id === 1) {
      ...
      deniedReason.value = response?.notes || ''
  ...
  <div class="relative min-h-screen w-full overflow-hidden flex items-center justify-center">
    ...
    <div class="relative z-10 w-full max-w-md mx-4 bg-white/95 backdrop-blur rounded-2xl shadow-2xl px-10 py-10">
      ...
      <div class="flex justify-center mb-5">
        <img src="../../public/images/csu_seal.png" class="w-32 h-32 object-contain drop-shadow" />
      </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-8 text-center">
          ...
          <div class="w-20 h-20 mx-auto mb-5">
            <svg viewBox="0 0 80 80" fill="none" class="w-full h-full">
              ...
              <path d="M40 24v18l10 6" stroke="#15803d" stroke-width="3.5" stroke-linecap="round"
    ...
    <Transition name="modal">
      <div v-if="showDenied"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-8 text-center">
          ...
          <div class="w-20 h-20 mx-auto mb-5">
            <svg viewBox="0 0 80 80" fill="none" class="w-full h-full">
              <circle cx="40" cy="40" r="36" stroke="#dc2626" stroke-width="3" stroke-dasharray="226"
                stroke-dashoffset="226" style="animation: drawCircle 0.6s ease forwards;" />
              <circle cx="40" cy="40" r="36" fill="#fff1f2" style="animation: fadeFill 0.3s ease 0.3s both;" />
              <path d="M28 28l24 24M52 28L28 52" stroke="#dc2626" stroke-width="3.5" stroke-linecap="round"
                stroke-dasharray="40" stroke-dashoffset="40" style="animation: drawCheck 0.4s ease 0.55s forwards;" />
            </svg>
          </div>
          ...
          <div
            class="inline-flex items-center gap-2 bg-red-50 border border-red-200 text-red-700 text-xs font-bold uppercase tracking-widest px-4 py-2 rounded-full mb-4">
          ...
          <div v-if="deniedReason" class="bg-red-50 border border-red-200 rounded-xl p-4 mb-5 text-left">
