...
<template>
  ...
  >
    ...
    >
      ...
      <p
        class="text-center text-xs text-gray-400 tracking-widest uppercase mb-8"
      >
      ...
      >
        ...
        >
          ...
          <p class="text-gray-500 text-sm leading-relaxed mb-5">
            ...
            <span class="font-semibold text-gray-700">under review</span> by the
            Director. You will be able to sign in once your registration has
            been approved.
          </p>
          ...
          >
            <div class="flex items-center gap-2 text-xs text-gray-500">
              ...
              Average review time:
              <span class="font-semibold text-gray-700">1–2 business days</span>
            </div>
            <div class="flex items-center gap-2 text-xs text-gray-500">
              <svg
                viewBox="0 0 20 20"
      ...
      >
        ...
        >
          ...
          <p class="text-gray-500 text-sm leading-relaxed mb-4">
            ...
            <span class="font-semibold text-gray-700">not approved</span> by the
            Director.
          </p>
          ...
          <div
            class="bg-gray-50 border border-gray-200 rounded-xl p-4 mb-6 text-left"
          >
            <div class="flex items-center gap-2 text-xs text-gray-500">
              <svg
                viewBox="0 0 20 20"
