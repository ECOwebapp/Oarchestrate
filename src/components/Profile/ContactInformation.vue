        ...
        <div class="w-44">
            ...
            <div v-for="(num, index) in form.phone" :key="index" class="relative">
                <input v-model="form.phone[index]" type="tel" inputmode="numeric" pattern="^09\d{9}$"
                    placeholder="09 123 45678" maxlength="11" class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm text-gray-600 
                   focus:text-black focus:outline-none focus:ring-1 focus:ring-green-700" />
            </div>
        </div>
        <div class="flex-1">
            ...
            <div v-for="(num, index) in form.email_address" :key="index" class="relative">
                <input v-model="form.email_address[index]" type="email" id="email"
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm text-gray-600 focus:text-black ocus:outline-none focus:ring-1 focus:ring-green-700" />
            </div>
        </div>
    </div>
    <!-- Action Buttons -->
