...
<template>
    <div>
        <div
            class="grid min-w-0 max-h-140 xl:max-h-full overflow-y grid-cols-1 gap-4 overflow-x-hidden xl:grid-cols-[280px_minmax(0,1fr)]"
        >
            <div
            ...
            >
                ...
                >
                    ...
                    >
                        <Icons
                            icon="profile"
                            class="h-16 w-16 text-gray-400 sm:h-20 sm:w-20"
                        />
                    </div>
                ...
                <ul
                    class="w-full max-w-[240px] list-inside list-disc space-y-1 text-[11px] leading-snug text-rose-500"
                >
            ...
            >
                ...
                <div
                    class="mb-3.5 grid grid-cols-1 gap-2.5 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_84px]"
                >
                    <div class="min-w-0">
                        <label
        ...
        <!-- Action Buttons -->
        <div
            class="mt-1 pt-1 lg:pt-0 flex w-full flex-col-reverse gap-3 sm:flex-row sm:justify-end"
        >
            <button
