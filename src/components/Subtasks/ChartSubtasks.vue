...
<template>
    <div
        class="relative h-full border border-gray-200 rounded-xl overflow-hidden shadow-sm"
    >
        <div
        ...
        >
            ...
            <template #taskbar-tooltip="{ task }">
                <div class="p-2 min-w-50 max-w-70 z-9999999999">
                    <div
                        class="font-bold text-[13px] mb-[8px] pb-[6px] border-b border-b-white/30 text-white"
                    >
                        {{ task.name }}
                    </div>
                    <div v-for="(value, key) in task" :key="key">
                        ...
                        >
                            <span
                                class="opacity-80 min-w-[80px] text-white text-[10px] font-bold"
                            >
                                {{ formatKey(key) }}:
                            </span>
                            <span
