...
<template>
    <div class="relative flex flex-col rounded-2xl h-30 w-120 py-2 px-4 overflow-hidden bg-white shadow-md hover:shadow-lg"
        :class="props.urgent === true ? 'outline-3 outline-red-500 text-red-500 shadow-red-500/90 hover:shadow-red-500/70' :
            'outline-2 outline-green-900 text-green-900 shadow-green-900/90 hover:shadow-green-900/70'">

        <!-- Ribbon -->
        <div v-if="props.urgent === true" class="absolute top-0 right-0 h-16 w-16">
            <div class="absolute transform rotate-45 bg-red-500 text-white text-1xl 
        ...
        <div class="flex flex-row items-center justify-evenly mt-3 gap-1">
            <div class="w-70 bg-gray-200 rounded-full h-2 overflow-hidden">
                <div class="h-full transition-all duration-500 ease-out"
                    :class="props.urgent === true ? 'bg-red-500' : 'bg-green-900'"
