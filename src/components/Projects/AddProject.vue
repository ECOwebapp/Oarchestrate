  ...
  <div class="bg-white w-full max-w-lg max-h-[90vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden">
    ...
    <div class="overflow-y-auto flex-1 px-7 py-5 space-y-4">
      ...
      <div>
        ...
        <input v-model="newProject.title" type="text" maxlength="100" placeholder="Task title…" class="w-full border-2 border-gray-300 rounded-xl h-11 px-3 text-sm
      ...
      <div>
        ...
        <textarea v-model="newProject.description" rows="4" maxlength="500" placeholder="Describe the task…" class="w-full border-2 border-gray-300 rounded-xl px-3 py-2 text-sm resize-none
                 focus:outline-none focus:border-green-800 transition-colors" />
        <p class="text-xs text-gray-400 mt-0.5">{{ newProject.description.length }}/500</p>
      </div>
      ...
      <div class="flex gap-3">
        <div class="flex-1">
          ...
          <input v-model="newProject.deadline" type="date" class="w-full border-2 border-gray-300 rounded-xl h-11 px-3 text-sm
