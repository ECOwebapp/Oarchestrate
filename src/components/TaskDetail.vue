      ...
      <div class="flex-1 min-h-0 flex flex-col overflow-hidden">
        ...
        >
          ...
          <div>
            ...
            <template
              v-if="task.outputLink && !editingSubmission && !confirmingDelete"
            >
              <div
              ...
              <div class="space-y-2.5">
                ...
                >
                  ...
                  >
                    <svg
                      viewBox="0 0 24 24"
                      class="w-5 h-5"
                      :class="dragOverEdit ? 'text-green-700' : 'text-gray-400'"
                      fill="currentColor"
                    >
                ...
                >
                  ...
                  <button
                    @click="
                      editFile = null;
                      editInputRef && (editInputRef.value = '');
                    "
                ...
                <div class="flex gap-2">
                  ...
                  <button
                    ...
                    :disabled="acting === 'editOutput' || !editFile"
                ...
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-red-600 mt-0.5 leading-relaxed">
                      The submitted file will be removed and the task will
                      return to "awaiting submission" state. The reviewer will
                      be notified.
                    </p>
                  </div>
                </div>
            ...
            <div v-else-if="canResubmit" class="space-y-2.5">
              ...
              >
                ...
                <div class="min-w-0">
                  <p class="text-xs font-bold text-orange-700 mb-0.5">
              ...
              >
                ...
                <button
                  @click="
                    resubmitFile = null;
                    resubInputRef && (resubInputRef.value = '');
                  "
                  class="text-gray-300 hover:text-red-400 transition-colors flex-shrink-0"
                >
                  <svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
          ...
          >
            ...
            <textarea
              ...
              :class="
                revisionComment.trim() ? 'border-amber-300 bg-amber-50' : ''
              "
            />
          ...
          <div class="flex-1 overflow-y-auto px-6 sm:px-8 py-5 space-y-4">
            ...
            <template v-else>
              <div
                ...
                class="flex gap-3"
                :class="
                  rev.from_user === auth.user?.id ? 'flex-row-reverse' : ''
                "
              >
                <div
                  ...
                  :class="
                    rev.roleLabel.toLowerCase() === 'director'
                      ? 'bg-green-900'
                      : 'bg-amber-600'
                  "
                >
      ...
      >
        ...
        <template v-if="props.task?.design && canApproveAsDesignRole">
          <button
            ...
            :title="
              !revisionComment.trim() ? 'Write revision notes above first' : ''
            "
